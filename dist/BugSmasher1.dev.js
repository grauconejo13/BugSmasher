...
var canTop = canvas.offsetTop; // Background image
...
bgImage.src = "wall2-2.jpg"; // bug objects
...
bugImage.src = "scarab1.png"; // Speed / time variables 

var speed = 2000;
var newSpeed = speed;
var speedFactor = 1.2; // Changes in the game when the user clicks on the bug
...
var then = Date.now();
reset();
main(); //19FEB2024_issue - bug multiplying ~ need to be fix.
...
//# sourceMappingURL=BugSmasher1.dev.js.map
